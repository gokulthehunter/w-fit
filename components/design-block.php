<div class="design-block">
    <div class="container d-block d-lg-none">
        <div class="row">
            ...
            <div class="col-12">
                <div class="design-block--title text-center">
                    <h3>The Design</h3>
                </div>
            </div>
            <div class="col-12">
                ...
                <div class="design-block--slider swiper-container" data-slidesPerView="1" data-spaceBetween=0 data-loop="true" data-centeredSlides="false" data-autoplay="true" data-delay="3000" data-slidesPerView320="1" data-slidesPerView480="1" data-slidesPerView640="1" data-slidesPerView991="1">
    ...
    <div class="container-fluid d-none d-lg-block">
        <div class="row">
            <div class="col-6">
                <div class="design-block--inner container-fluid-container-pad-left">
                    <div class="design-block--inner--each active">
                        <h3>Durability</h3>
                        <p>
                        The mattress is recommended for use on the white side, for realizing the benefits from the CoolFit foam as well as the memory.
                        </p>
                    </div>

                    <div class="design-block--inner--each">
                        <h3>Durability</h3>
                        <p>
                        The mattress is recommended for use on the white side, for realizing the benefits from the CoolFit foam as well as the memory.
                        </p>
